...
class CsvContactParserTest {
    @Test
    void csvContactParser(@Named("csv") ContactParser contactParser,
                          ResourceLoader resourceLoader) throws IOException {
        assertTrue(contactParser instanceof CsvContactParser);
        Optional<InputStream> inputStreamOptional = resourceLoader.getResourceAsStream("classpath:micronaut.csv");
